...
(JAS) Impact of Vertical Wind Shear on Asymmetry of
Stratospheric Gravity Waves Generated by Tropical Cyclones
- 命中关键词：tropical cyclone
- 链接：https://journals.ametsoc.org/...
- AI 总结：本文研究了垂直风切变对热带气旋激发的平流层
  重力波不对称性的影响，利用数值模拟方法分析了风切变
  强度与重力波传播方向的关系，发现风切变显著增强了下
  风方向的重力波振幅，并对平流层动量通量分布产生重要影响。
